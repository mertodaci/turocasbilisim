...
const TABLE_TO_MODULE = {
  ...
  stok_zimmet_yerleri: 'stok_zimmet_yerleri',
  ...
  guvenlik_ayarlari: 'oturum_yonetimi',
  takvim_etkinlikleri: 'personal_calendar',
...
const ALLOWED_COLUMNS = {
  ...
  stok_zimmet_yerleri: ['ad','aciklama','aktif','is_deleted'],
  ...
  guvenlik_ayarlari: ['idle_timeout_dakika','calisma_saatleri_aktif','calisma_baslangic','calisma_bitis','calisma_gunleri','updated_by'],
  takvim_etkinlikleri: ['baslik','aciklama','tarih','baslangic_saat','bitis_saat','owner_email'],
...
const SENSITIVE_EMPLOYEE_FIELDS = ['tc','iban','bank_name','tax_office','tax_number','sgk_number','disability_status','blood_type','emergency_contact','emergency_phone','emergency_contacts','address','notes','exit_reason','exit_notes','exit_document','marital_status','military_status','education_documents','birth_date','gender','card_uid','personel_adresi','kanun_no','aylik_ucret','saatlik_ucret','dakikalik_ucret','ticket_aylik','sahsi_hesap_aktif','sahsi_hesap_tutar','sahsi_hesap_banka','sahsi_hesap_iban','sahsi_hesap_aciklama'];
