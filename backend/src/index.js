...
app.use('/api/entities/takvim_etkinlikleri',   createEntityRouter('takvim_etkinlikleri'));
...
app.get('/api/dashboard/executive', authMiddleware, requireRoles('admin','yonetici'), (req, res) => {
  try {
    ...
    res.json({
      ...
      sales: { totalCustomers, potentialCustomers },
      ...
      trends: { expenses: expenseTrend, expensesPending: expenseTrendPending, expenseByCategory },
