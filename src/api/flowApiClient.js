...
export const stok = {
  ...
  async demirbasDepoSicilListesi(urun_id, depo_id) { return handleResponse(await fetch(`${BASE_URL}/api/stok/demirbas-depo-sicil-listesi?urun_id=${urun_id}&depo_id=${depo_id}`, { credentials: 'include' })); },
