...
const ENTITY_MAP = {
  ...
  TQProject:        'tq_projects',
  TQTicket:         'tq_tickets',
  TQTicketStatus:   'tq_ticket_statuses',
  TQComment:        'tq_comments',
  TQEffortPlan:     'tq_effort_plans',
  TQEffortLog:      'tq_effort_logs',
  TQKanbanBoard:    'tq_kanban_boards',
  CardLog:          'card_logs',
  Role:             'roles',
