...
export default function TQDeadlineList({ deadlines }) {
    ...
    <div className="space-y-2">
      {deadlines.map((ticket) => {
        ...
        return (
          <div
            key={ticket.id}
            onClick={() => window.location.href = `/taskqube-v3/tickets?search=${ticket.ticket_number}`} className="flex items-center justify-between p-3 border border-border rounded-lg hover:bg-muted/50 transition-colors cursor-pointer"
          >
