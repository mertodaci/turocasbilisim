...
export default function TQTicketFormDialog({ ticket, projects, customers, employees, boards = [], open, onOpenChange, defaultBoardId = null, defaultBoardName = null, defaultStatus = null, isMusteri = false, currentUser = null }) {
  ...
  const renameAttachmentMutation = useMutation({
    mutationFn: ({ id, data }) => flowApi.entities.TQTicket.update(id, data),
  ...
  // -active, vb.) tek seferde tazeler -- bkz. taskqubeQueryUtils.js.
  const invalidateBoardTickets = () => invalidateTicketQueries(queryClient);

  const createMutation = useMutation({
    mutationFn: (data) => flowApi.entities.TQTicket.create(data),
    onSuccess: () => {
