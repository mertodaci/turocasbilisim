...
const CATEGORIES = [
  ...
  { label: "Stok — İşlemler", keys: ["stok_giris", "stok_cikis", "stok_transfer", "stok_iade", "stok_talep", "stok_rezervasyon", "stok_fisler", "stok_sayim", "stok_parti_takibi"] },
  ...
  { label: "İK/Bordro — İşlemler", keys: ["ikb_personel", "ikb_zam", "ikb_ozluk_evrak", "ikb_izin_evrak", "ikb_vip", "ikb_cikis", "ikb_vardiya_atama", "ikb_puantaj", "ikb_mesai", "ikb_kesinti", "ikb_ic_borc", "ikb_personel_masraf", "ikb_bordro", "ikb_ay_kapanis", "ikb_toplu_yukleme", "ikb_tutanak", "ikb_ilan"] },
