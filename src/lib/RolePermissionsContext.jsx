...
export const MODULES = [
  ...
  { key: "ik_tanimlar",         label: "Çalışan Tanımları",      path: "/ik-tanimlar" },
  ...
  { key: "ikb_qr_harita",       label: "QR Konum Haritası",      path: "/ik/qr-harita" },
  ...
  { key: "ikb_personel_masraf", label: "Personel Masrafları",    path: "/ik/personel-masraf" },
  { key: "ikb_bordro",          label: "Bordrolama",             path: "/ik/bordro" },
  { key: "ikb_maas_ozet",       label: "Maaş Özet Raporu",       path: "/ik/maas-ozet" },
  { key: "ikb_ay_kapanis",      label: "Ay Kapanışı",            path: "/ik/ay-kapanis" },
  { key: "ikb_toplu_yukleme",   label: "Toplu Excel Yükleme",    path: "/ik/toplu-yukleme" },
...
export const DEFAULT_PERMISSIONS = {
  ...
  kullanici: { ...none(), dashboard:{view:true,add:false,edit:false,delete:false}, customers:{view:true,add:false,edit:false,delete:false}, calendar:{view:true,add:false,edit:false,delete:false}, activities:{view:true,add:true,edit:true,delete:false}, add_activity:{view:true,add:true,edit:true,delete:false}, work_tracking:{view:true,add:true,edit:true,delete:false}, ideas:{view:true,add:true,edit:false,delete:false}, messages:{view:true,add:true,edit:true,delete:true}, todos:{view:true,add:true,edit:true,delete:true}, my_leave_requests:{view:true,add:true,edit:false,delete:true}, personal_calendar:{view:true,add:false,edit:false,delete:false}, customer_map:{view:true,add:false,edit:false,delete:false}, expenses:{view:true,add:true,edit:true,delete:false}, is_takibi:{view:true,add:true,edit:true,delete:false}, is_takibi_dashboard:{view:true,add:false,edit:false,delete:false}, is_takibi_projeler:{view:true,add:false,edit:false,delete:false}, is_takibi_biletler:{view:true,add:true,edit:true,delete:false}, is_takibi_kanban:{view:true,add:false,edit:false,delete:false} },
