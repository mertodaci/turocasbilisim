...
import JTDeadlineList from "@/components/jobtracking/JTDeadlineList";
import JTCustomerAssignmentList from "@/components/jobtracking/JTCustomerAssignmentList";
  ...
  if (tickets.length === 0 && projects.length === 0) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-foreground">İş Takibi Dashboard</h1>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link to="/is-takibi/tickets?group=musteri_talep" className="block">
        ...
        <Link to="/is-takibi/tickets?status=acil_isler" className="block">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <JTDashboardChart tickets={tickets} />
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <JTDeadlineList deadlines={upcomingDeadlines} />
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <JTCustomerAssignmentList customerStats={customerStats} />
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>
              <Link to="/is-takibi" className="flex items-center gap-2 hover:underline">
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              <Link to="/is-takibi/tickets" className="flex items-center gap-2 hover:underline">
          ...
          <CardContent>
            <div className="space-y-3">
              {recentTickets.map((ticket) => (
                <Link key={ticket.id} to="/is-takibi/tickets" className="flex items-center justify-between p-3 border border-border rounded-lg hover:bg-muted/30 hover:border-primary/30 transition-colors cursor-pointer">
